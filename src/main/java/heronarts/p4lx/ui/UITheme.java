...
public class UITheme {
  ...
  UITheme(PApplet applet) {
    ...
    LX.initProfiler.log("P4LX: UI: Theme: controlFont");
    ...
    LX.initProfiler.log("P4LX: UI: Theme: windowTitleFont");
    ...
    this.iconView = applet.loadImage("icon-view.png");
    LX.initProfiler.log("P4LX: UI: Theme: Icons");
  }
