...
public abstract class UI2dComponent extends UIObject {
  ...
  public UI2dComponent addToContainer(UIContainer container, int index) {
    if (this.parent != null) {
      P4LX.warning("Adding component to container when it's already in another, this is discouraged: " + this.getClass());
      removeFromContainer();
    }
  ...
  protected void drawBackground(UI ui, PGraphics pg) {
    ...
    if (!ownBackground || (this.borderRounding > 0)) {
      ...
      while ((component != null) && (component instanceof UI2dComponent)) {
        ...
        if (component2d.hasBackground || (component2d.hasFocus && component2d.hasFocusBackground)) {
          int fill = (component2d.hasFocus && component2d.hasFocusBackground) ? component2d.focusBackgroundColor : component2d.backgroundColor;
          pg.stroke(fill);
          pg.fill(fill);
    ...
    if (ownBackground) {
      int fill = (this.hasFocus && this.hasFocusBackground) ? this.focusBackgroundColor : this.backgroundColor;
      pg.stroke(fill);
      pg.fill(fill);
      pg.rect(0, 0, this.width-1, this.height-1, this.borderRounding);
    }
