...
public class UI implements LXEngine.Dispatch {
  ...
  private UI(PApplet applet, final P4LX lx) {
    if (UI.instance != null) {
  ...
  public void keyEvent(KeyEvent keyEvent) {
    // Do not close on the ESC key, P4LX UI uses it
